...
[![My Skills](https://skillicons.dev/icons?i=androidstudio,flutter,angular,html,css,bootstrap,cs,dotnet,dart,docker,nodejs,js,jest,express,nestjs,ts,figma,azure,git,github,heroku,vercel,mysql,postgres,postman,sequelize,visualstudio,vscode&perline=10)](https://skillicons.dev)
